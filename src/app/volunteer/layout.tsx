  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex">
      ...
      <div className="md:hidden fixed top-0 w-full glass-panel border-t-0 border-x-0 rounded-none p-4 pb-2 z-40 space-y-2">
         <h1 className="text-lg font-bold">Volunteer Portal</h1>
         <nav className="flex gap-4 overflow-x-auto pb-1 scrollbar-hide text-xs font-semibold">
           <Link href="/volunteer" className="text-gray-500 hover:text-[var(--foreground)]">Tasks</Link>
           <Link href="/volunteer/assistance" className="text-gray-500 hover:text-[var(--foreground)]">Help Requests</Link>
